...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno) {
        ...
        name.setBounds(150, 140, 100, 30);
        add(name);
        
        String valReligion[] = {"Hindu", "Muslium", "Sikh", "Christian", "Other"};
        ...
        String valCategory[] = {"General", "OBC", "SC", "ST", "VJNT", "Other"};
        ...
        String incomecategory[] = {"Null", "1 Lakh", "3 Lakh", "5 Lakh", "Upto 10 Lakh", "Above 10 Lakh"};
        ...
        String occupationValues[] = {"Student", "Goverment-Job", "self-Employed", "Bussiness", "Salaried", "Retired", "Others"};
