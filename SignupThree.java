...
public class SignupThree extends JFrame implements ActionListener{
  ...
  SignupThree(String formno){
      ...
      JLabel number = new JLabel("XXXX-XXXX-XXXX-4196");
     ...
     JLabel pindetail = new JLabel("Your 4 Digit Password");
      ...
      c4 = new JCheckBox("EMIAL & SMS Alerts");
      ...
      c7 = new JCheckBox(" Herby declares that theabove entered details are correct to the best of my knowledge");
